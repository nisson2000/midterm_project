            ...
            {loading ? (
                ...
                <div className="flex flex-col justify-center p-16 gap-2">
                    <h1 className="font-bold text-3xl">
                        Become a <strong className="text-blue-500">Member</strong>
                    </h1>
                    <p>
                        enter the correct passcode to become a <strong className="text-blue-500">Member</strong>
                    </p>
                    <form className="flex flex-col justify-center gap-2" onSubmit={become_member}>
